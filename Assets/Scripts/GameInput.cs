...
{
    private const string PLAYER_REFS_BINDINGS = "InputBindings";
    ...
    private void Awake()
    {
        ...
        if(PlayerPrefs.HasKey(PLAYER_REFS_BINDINGS))
        {
            playerInputActions.LoadBindingOverridesFromJson(PlayerPrefs.GetString(PLAYER_REFS_BINDINGS));
        }
    ...
    public void Rebinding(GameInput.Binding binding, Action onActionRebound)
    {
            ...
            .OnComplete(callback =>
                {
                    ...
                    playerInputActions.Player.Enable();
                    onActionRebound();
                    PlayerPrefs.SetString(PLAYER_REFS_BINDINGS, playerInputActions.SaveBindingOverridesAsJson());
                    PlayerPrefs.Save();
                }
            ).Start();
    }

...
public class Player : MonoBehaviour, IKitchenObjectParent
{
    ...
    [SerializeField] private Transform kitchenObjectHoldingPosition;
    ...
    {
        if (!MyGameManager.Instance.IsGamePlaying()) return;
    ...
    private void HandleMovement()
    {
        ...
        if (!canMove)
        {
            ...
            canMove = (moveDir.x > 0.5f || moveDir.x < -0.5f) && !Physics.CapsuleCast(transform.position, playerHeadPosition, playerRadius, moveDirX, moveDistance);
            ...
            else
            {
                ...
                canMove = (moveDir.z > 0.5f || moveDir.z < -0.5f) && !Physics.CapsuleCast(transform.position, playerHeadPosition, playerRadius, moveDirZ, moveDistance);
    ...
    {
        return kitchenObjectHoldingPosition;
    }
